...
# Custom Datamodule:
from logo_data_module import LoGoDataModule
...
class BYOL(LightningModule):
    ...
    def __init__(
        ...
        max_epochs: int = 1000,
        base_encoder: Union[str, torch.nn.Module] = "convnext_small",
    ...
    def configure_optimizers(self):
        ...
        scheduler = LinearWarmupCosineAnnealingLR(
            optimizer, warmup_epochs=self.hparams.warmup_epochs, max_epochs=100 #self.hparams.max_epochs
        )
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument("--dataset", type=str, default="medical", choices=["cifar10", "imagenet2012", "stl10", "medical"]) #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        parser.add_argument("--tags", nargs="*", default=["BYOL"], type=str, help="Wandb tags, default = CEM500K")
        parser.add_argument("--name", default="Test", type=str, help="Set run name to identify run in wandb web UI.")
...
def cli_main():
    ...
    # New:
        ...
        dm = LoGoDataModule(**args.__dict__, mean=MED_MEAN, std=MED_STD)
        args.num_classes = 1
    ...
    # New:
    trainer = Trainer.from_argparse_args(args, max_steps=300000, logger=wandb_logger, callbacks=model_checkpoint)
