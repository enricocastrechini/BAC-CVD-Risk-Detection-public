...
_import_resnets_for_timm_registration = (ConvNeXt)
...
def build_sparse_encoder(name: str, input_size: int = None, input_width: int = None, input_height: int = None, sbn=False, drop_path_rate=0.0, verbose=False):
    ...
    return SparseEncoder(cnn, input_width=input_width, input_height=input_height, sbn=sbn, verbose=verbose)
